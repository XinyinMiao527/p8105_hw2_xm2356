...
The combined Trash Wheel dataset contains `r trash_summary$n_obs` observations from three sources: Mr. Trash Wheel, Professor Trash Wheel, and Gwynnda. Key variables include date of collection, weight in tons, volume in cubic yards, and counts of items such as plastic bottles, cigarette butts, and sports balls. For example, Professor Trash Wheel has collected a total of `r round(trash_summary$prof_total_weight, 2)` tons of trash, while Gwynnda collected `r trash_summary$gwynnda_cigs_june2022` cigarette butts in June 2022.
