...
in a wide format with each month as a separate column.
...
sources: Mr. Trash Wheel, Professor Trash Wheel, and Gwynns Falls. Key
variables include date of collection, weight in tons, volume in cubic
yards, and counts of items such as plastic bottles, cigarette butts, and
sports balls. For example, Professor Trash Wheel has collected a total
of 282.26 tons of trash, while Gwynns collected 1.812^{4} cigarette
butts in June 2022.
